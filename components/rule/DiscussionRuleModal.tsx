                ...
                {onClose => (
                    <>
                        ...
                        <ModalBody>
                            ...
                            <p className="text-sm">
                                1.1.1. Bằng cách đăng bài thảo luận trên nền tảng của chúng tôi, bạn đồng ý và tuân thủ
                                theo các điều khoản và điều kiện dưới đây.
                            </p>
                            <h4 className="font-semibold">1.2 Trách nhiệm:</h4>
                            <p className="text-sm">
                                1.2.1. Bạn chịu trách nhiệm đầy đủ về nội dung bạn đăng, đảm bảo rằng nó tuân thủ quy
                                định và không vi phạm các chính sách của chúng tôi.
                            </p>
                            <h3 className="font-bold">2. Nội dung và Hành vi:</h3>
                            <h4 className="font-semibold">2.1. Chất lượng nội dung:</h4>
                            <p className="text-sm">
                                2.1.1. Bạn cam kết cung cấp các bài thảo luận chất lượng, xây dựng và tích cực.
                            </p>
                            <h4 className="font-semibold">2.2. Tôn trọng:</h4>
                            <p className="text-sm">
                                2.2.1. Bạn đồng ý không thể hiện hành vi lạm dụng, phân biệt đối xử, hay xâm phạm quyền
                                riêng tư của người khác trong các bài thảo luận.
                            </p>
                            <h3 className="font-bold">3. Quyền lợi và Trách nhiệm:</h3>
                            <h4 className="font-semibold">3.1. Quản lý nội dung:</h4>
                            <p className="text-sm">
                                3.1.1. Chúng tôi có quyền xem xét, chỉnh sửa hoặc xóa bất kỳ bài thảo luận nào mà chúng
                                tôi cho là không tuân thủ các quy định và chính sách của chúng tôi.
                            </p>
                            <h4 className="font-semibold">3.2. Bảo vệ quyền riêng tư:</h4>
                            <p className="text-sm">
                                3.2.1. Chúng tôi cam kết bảo vệ quyền riêng tư của bạn và không tiết lộ thông tin cá
                                nhân không được sự đồng ý của bạn.
                            </p>
                            <h3 className="font-bold">4. Hạn chế trách nhiệm:</h3>
                            <h4 className="font-semibold">4.1 Hạn chế trách nhiệm:</h4>
                            <p className="text-sm">
                                4.1.1. Chúng tôi không chịu trách nhiệm về bất kỳ thiệt hại nào phát sinh từ việc sử
                                dụng thông tin trong bài thảo luận.
                            </p>
