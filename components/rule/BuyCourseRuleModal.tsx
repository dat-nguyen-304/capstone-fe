                ...
                {onClose => (
                    <>
                        ...
                        <ModalBody>
                            ...
                            <p className="text-sm">
                                Bằng cách mua bất kỳ khóa học nào trên nền tảng của chúng tôi, bạn đồng ý và tuân thủ
                            ...
                            <p className="text-sm">
                                Bạn đồng ý thanh toán đầy đủ số tiền mua khóa học theo các phương thức thanh toán mà
                                chúng tôi chấp nhận.
                            </p>
                            <h4 className="font-semibold">2.2. Hóa đơn:</h4>
                            <p className="text-sm">
                                Hóa đơn mua hàng sẽ được cung cấp và có thể được tìm thấy trong lịch sử giao dịch từ tài
                                khoản của bạn.
                            </p>
                            ...
                            <p className="text-sm">
                                Bạn có quyền truy cập vào tất cả nội dung và tài nguyên của khóa học mà bạn đã mua trong
                                khoảng thời gian có hiệu lực.
                            </p>
                            <h4 className="font-semibold">3.2. Chất lượng nội dung:</h4>
                            <p className="text-sm">
                                Chúng tôi cam kết cung cấp nội dung chất lượng và giảng dạy có giá trị.
                            </p>
                            <h3 className="font-bold">4. Hoàn tiền</h3>
                            <h4 className="font-semibold">4.1 Chính sách hoàn tiền:</h4>
                            <p className="text-sm">
                                Khóa học chỉ được hoàn tiền trong 3 ngày kể từ khi thanh toán thành công khóa học
                            </p>
